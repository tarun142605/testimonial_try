...
export default function Example() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5 px-3 py-0 text-gray-600 hover:text-indigo-600 font-bold">
          Customers<ChevronDownIcon className="w-5 h-5" />
        </MenuButton>
      </div>
